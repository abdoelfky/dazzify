...
import 'package:dazzify/core/services/app_events_logger.dart' as _i818;
...
import 'package:dazzify/core/services/search_history_service.dart' as _i611;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i174.GetIt init({
    ...
    gh.lazySingleton<_i818.AppEventsLogger>(
        () => featuresModule.appEventsLogger);
    gh.lazySingleton<_i161.InternetConnection>(
        () => featuresModule.internetConnection);
    gh.lazySingleton<_i611.SearchHistoryService>(
        () => _i611.SearchHistoryService());
    ...
    gh.factory<_i637.RecommendationDetailsCubit>(
        () => _i637.RecommendationDetailsCubit(gh<_i660.HomeRepository>()));
