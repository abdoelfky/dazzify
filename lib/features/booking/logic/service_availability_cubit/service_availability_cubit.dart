...
class ServiceAvailabilityCubit extends Cubit<ServiceAvailabilityState> {
  ...
  ServiceAvailabilityCubit(this._repository)
      : super(const ServiceAvailabilityState());

  Future<dynamic> _getAvailableBrandSlots({
    ...
    Either<Failure, List<VendorSessionModel>> result =
        await _repository.getBrandServiceAvailableSlots(
