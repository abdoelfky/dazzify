...
class GuestModeWidget extends StatefulWidget {
  const GuestModeWidget({super.key});

  @override
  State<GuestModeWidget> createState() => _GuestModeWidgetState();
}

class _GuestModeWidgetState extends State<GuestModeWidget> {
            ...
            children: [
              ...
              Text(
                ...
                style: TextStyle(
                  ...
                  color: Colors.black, // Text color (customize as needed)
                ),
              ),
              SizedBox(height: 20.0),
